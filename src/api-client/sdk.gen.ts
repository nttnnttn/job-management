...
export const jobsControllerFindAll = <ThrowOnError extends boolean = false>(options?: Options<JobsControllerFindAllData, ThrowOnError>) => (options?.client ?? client).get<JobsControllerFindAllResponses, JobsControllerFindAllErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/jobs',
    ...options
});
...
export const jobsControllerFindOne = <ThrowOnError extends boolean = false>(options: Options<JobsControllerFindOneData, ThrowOnError>) => (options.client ?? client).get<JobsControllerFindOneResponses, JobsControllerFindOneErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/jobs/{id}',
    ...options
});
...
export const jobCandidateControllerCreate = <ThrowOnError extends boolean = false>(options: Options<JobCandidateControllerCreateData, ThrowOnError>) => (options.client ?? client).post<JobCandidateControllerCreateResponses, JobCandidateControllerCreateErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/job-candidate',
    ...options,
    headers: {
...
export const jobCandidateControllerUpdate = <ThrowOnError extends boolean = false>(options: Options<JobCandidateControllerUpdateData, ThrowOnError>) => (options.client ?? client).patch<JobCandidateControllerUpdateResponses, JobCandidateControllerUpdateErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/job-candidate/{id}',
    ...options,
    headers: {
